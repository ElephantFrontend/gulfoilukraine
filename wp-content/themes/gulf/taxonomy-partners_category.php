...
if($categories){
	...
	foreach ($categories as $cat){
 	   if($thiscat->slug == $cat->slug) {?>	
 	   		<?php  echo "<option selected value='/partners_category/{$cat->slug}'>{$cat->name}</option>";
 	   }else {
 	   		echo "<option value='/partners_category/{$cat->slug}'>{$cat->name}</option>";
 	   };
	}
	echo '</select>';
}
